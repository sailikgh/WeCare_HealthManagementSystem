...
<table class="w3-table-all w3-card-4">
    ...
    <?php
        ...
        $stmt = $con->prepare("select pat_id, concat(pat_fname, ' ', pat_lname) as pname from wc_patient where userid=?;");
        ...
        else
        {
            ...
            {
                echo "<tr><td>". $row['pat_id'] ."</td><td>". $row['pname'] ."</td><td>". "<a href=patsinvoice.php?id=".$row['pat_id']."><b>View Invoices</b></a>"."</td></tr>"; 
            }
                echo "</table>";
        }
