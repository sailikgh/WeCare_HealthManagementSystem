...
<input type="text" id="myInput1" onkeyup="myFunction1()" placeholder="Enter Zipcode.." title="Type in Hospital Name">
...
<p> </p>
    ...
    <?php
        ...
        if(mysqli_num_rows($result) > 0)
        {
            ...
            { 
                echo "<tr><td>". $row['hos_id'] ."</td><td>". $row['hos_name'] ."</td><td>". $row['hos_st_address'] ."</td><td>". $row['city'] ."</td><td>". $row['state'] ."</td><td>". $row['zipcode'] ."</td><td>". "<a href=hoscont.php?id=".$row['hos_id'].">Contact</a>" ."</td></tr>";
            }
            echo "</table>";  
