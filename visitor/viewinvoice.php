...
<p> </p>
    ...
    <table class='w3-table-all w3-card-4' id="myTable">
      <tr class='w3-teal'>
        ...
        <th>Due</th>
        <th>View or Make Payments</th>

      </tr>

    <?php
        $stmt = $con->prepare("
        select a.user_id, c.inv_id, c.inv_date, a.pat_id, concat(a.pat_fname, ' ', a.pat_lname) as patname,
        ...
        from wc_insurance z join wc_patient a join wc_reg b join wc_invoice c where z.pat_id=a.pat_id and a.pat_id=b.pat_id and b.reg_id=c.reg_id and a.user_id=?;");
