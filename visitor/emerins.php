...
<div class="w3-row-padding w3-center w3-padding-64">
    ...
    <a href="emergencyform.php?id=<?php echo ($id)?>" class="w3-button w3-teal"><b>+</b> Add New</a>
    <p></p>
    ...
    <?php
        ...
        else
        {
            while ($row = $result->fetch_assoc())
            {
              echo"<tr><td>".$row['emc_id']."</td><td>".$row['emcname']."</td><td>".$row['emc_phone']."</td><td>".$row['addr']."</td><td>".$row['relation']."</td><td>"."<a href=adminemeredit.php?id=".$row['emc_id'].">Edit</a>"."</td><td>"."<a href=emerdelete.php?id=".$row['emc_id'].">Delete</a>"."</td></tr>";
            }
                echo " </table>";
        }
