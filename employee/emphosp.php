...
<p> </p>
    ...
    <?php
        $stmt = $con->prepare("select * from wc_hos a join wc_hos_doc b where a.hos_id=b.hos_id and b.doc_id=?;");
        ...
        if(mysqli_num_rows($result) > 0)
        {
            ...
            { 
                echo "<tr><td>". $row['hos_id'] ."</td><td>". $row['hos_name'] ."</td><td>". $row['hos_st_address'] ."</td><td>". $row['city'] ."</td><td>". $row['state'] ."</td><td>". $row['zipcode'] ."</td><td>". "<a href=emphospcon.php?id=".$row['hos_id'].">View</a>" ."</td></tr>";
            }
            echo "</table>";  
