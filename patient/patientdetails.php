...
<div class="w3-row-padding w3-center w3-padding-64">
    ...
    <?php
        ...
        else
        {
            while ($row = $result->fetch_assoc())
            {
              ...
              echo"<tr><td>".$row['pat_id']."</td><td>".$row['pat_race']."</td><td>".$row['pat_dob']."</td><td>".$row['pat_gender']."</td><td>".$row['pat_bldgrp']."</td><td>".$row['pat_maritalstat']."</td><td>".$row['pat_phone']."</td><td>".$row['padd']."</td><td>"."<a href=updatepatientform.php?id=".$row['pat_id'].">Edit</a>"."</td><td>"."<a href=deletepatient.php?id=".$row['pat_id'].">Delete</a>"."</td></tr>";
            }
                echo " </table>";
        }
    ...
    <?php
        $stmt = $con->prepare("select concat(a.emc_fname, ' ', a.emc_lname) as emcname, a.emc_phone, concat(a.emc_st_address, ' ', a.emc_city, ' ', a.emc_state, ' ', a.emc_zipcode) as addr , b.relation from  wc_pat_emc b join wc_emc a where a.emc_id=b.emc_id and pat_id=?;");
        ...
        else
        {
            while ($row = $result->fetch_assoc())
            {
              echo"<tr><td>".$row['emcname']."</td><td>".$row['emc_phone']."</td><td>".$row['addr']."</td><td>".$row['relation']."</td><td>"."<a href=>Edit</a>"."</td></tr>";
            }
                echo " </table>";
        }
