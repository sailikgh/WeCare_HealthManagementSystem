    ...
    <?php
        ...
        if(mysqli_num_rows($result) > 0)
        {
            ...
            { 
                ...
                echo "<tr><td>". $row['pat_id'] ."</td><td>". $row['pname'] ."</td><td>". $row['pat_dob'] ."</td><td>". $row['pat_race'] ."</td><td>". $row['pat_gender'] ."</td><td>". $row['pat_bldgrp'] ."</td><td>". $marstat ."</td><td>". $row['pat_phone'] ."</td><td>". $row['addr'] ."</td><td>". "<a href=emerins.php?id=".$row['pat_id'].">View</a>" ."</td><td>". "<a href=adminpatedit.php?id=".$row['pat_id'].">Edit</a>" ."</td>
                <td>". "<a href=adminfacdel.php?id=".$row['pat_id'].">Delete</a>" ."</td></tr>";
            }
            echo "</table>";  
