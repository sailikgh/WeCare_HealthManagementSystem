...
<div class="w3-row-padding w3-center w3-padding-64" id="pricing">
    ...
    <a href="reportform.php" class="w3-button w3-teal"
  style="position: fixed;bottom: 0;right: 0;">+ Add New Lab Report</a>
...
<p> </p>
    ...
    <?php
        $stmt = $con->prepare("select * from wc_lab;");
        $stmt->execute();
        ...
        if(mysqli_num_rows($result) > 0)
        {
            ...
            { 
                echo "<tr><td>". $row['treat_id'] ."</td><td>". $row['lab_name'] ."</td>
                <td>". $row['test_type'] ."</td>
                <td>". $row['test_date'] ."</td>
                <td>". $row['test_result'] ."</td>
                <td>". "<a href=editrep.php?id=".$row['treat_id'].">Edit</a>" ."</td><td>". "<a href=delrep.php?id=".$row['treat_id'].">Delete</a>" ."</td></tr>";
            }
            echo "</table>";  
