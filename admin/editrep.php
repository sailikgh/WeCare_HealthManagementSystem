...
<div class="w3-padding-5">
      <form class="w3-container w3-card-4 w3-padding-16 w3-white" action="editreport.php" method="POST">
      <div class="w3-section">      
        <label><b>Treatment ID <?=$id?></b></label>
        <input class="w3-input" type="hidden" name="treatid" id="treatid" value= <?=$id?>required>
      </div>
