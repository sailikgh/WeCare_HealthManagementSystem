...
<div class="w3-row-padding w3-center w3-padding-64" id="pricing">
    <h2>REPORTS</h2>
    <p>Choose one from below.</p><br>
    <div class="w3-third w3-margin-bottom">
      <ul class="w3-ul w3-border w3-hover-shadow">
        <li class="w3-theme">
          <p class="w3-xlarge">Labs</p>
        </li>
        <li class="w3-padding-16">Manage Lab Results</li>
        <li class="w3-theme-l5 w3-padding-24">
          <button onclick="location.href='adminlab.php'" class="w3-button w3-teal w3-padding-large"><i class="fa fa-check"></i> Go</button>
        </li>
      </ul>
    </div>
    ...
    <div class="w3-third w3-margin-bottom">
      <ul class="w3-ul w3-border w3-hover-shadow">
        <li class="w3-theme-l2">
          <p class="w3-xlarge">Surgery</p>
        </li>
        <li class="w3-padding-16">Manage Surgery Info</li>
        
        <li class="w3-theme-l5 w3-padding-24">
          <button onclick="location.href='adminsurg.php'" class="w3-button w3-teal w3-padding-large"><i class="fa fa-check"></i> Go</button>
        </li>
      </ul>
    </div>
    ...
    <div class="w3-third w3-margin-bottom">
      <ul class="w3-ul w3-border w3-hover-shadow">
        <li class="w3-theme">
          <p class="w3-xlarge">Prescriptions</p>
        </li>
        <li class="w3-padding-16">Manage Prescriptions</li>
        <li class="w3-theme-l5 w3-padding-24">
          <button onclick="location.href='adminpres.php'" class="w3-button w3-teal w3-padding-large"><i class="fa fa-check"></i> Go</button>
        </li>
      </ul>
    </div>
</div>
