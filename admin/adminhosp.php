...
<p> </p>
    ...
    <?php
        ...
        if(mysqli_num_rows($result) > 0)
        {
            ...
            { 
                echo "<tr><td>". $row['hos_id'] ."</td><td>". $row['hos_name'] ."</td><td>". $row['hos_st_address'] ."</td><td>". $row['city'] ."</td><td>". $row['state'] ."</td><td>". $row['zipcode'] ."</td><td>". "<a href=adminhospcont.php?id=".$row['hos_id'].">View</a>" ."</td><td>". "<a href=adminhospedit.php?id=".$row['hos_id'].">Edit</a>" ."</td></tr>";
            }
            echo "</table>";  
