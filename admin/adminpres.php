...
<div class="w3-row-padding w3-center w3-padding-64" id="pricing">
    ...
    <a href="presform.php" class="w3-button w3-teal"
  style="position: fixed;bottom: 0;right: 0;">+ Add New Prescription</a>
...
<p> </p>
    ...
    <?php
        $stmt = $con->prepare("select * from wc_drugpresc;");
        $stmt->execute();
        ...
        if(mysqli_num_rows($result) > 0)
        {
            ...
            { 
                ...
                <td>". $row['drug_name'] ."</td>
                <td>". $row['drug_dose'] ."</td>
                <td>". "<a href=editpres.php?id=".$row['treat_id'].">Edit</a>" ."</td><td>". "<a href=delpres.php?id=".$row['treat_id'].">Delete</a>" ."</td></tr>";
            }
            echo "</table>";  
