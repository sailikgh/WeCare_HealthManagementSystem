...
<div class="w3-padding-5">
      <form class="w3-container w3-card-4 w3-padding-16 w3-white" action="adddept.php" method="POST">
      ...
      <div class="w3-section"> 
        ...
        <?php
            $stmt = $con->prepare("select dept_id, dept_name from wc_dept;");
            $stmt->execute();
      ...
      <div class="w3-section">      
        ...
        <input class="w3-input" type="text" name="bldg" id="type" required>
      </div>

      <div class="w3-section">      
        <label>Floor</label>
        <input class="w3-input" type="text" name="floor" id="floor" required>
      </div>
