...
<div class="w3-row-padding w3-center w3-padding-64" id="pricing">
    ...
    <p>Manage Appointment of Registered Patients</p><br>
...
<p> </p>
    ...
    <?php
        $stmt = $con->prepare("select pat_id, concat(pat_fname, ' ', pat_lname) as pname, pat_dob, pat_race, pat_gender, pat_bldgrp, pat_maritalstat, pat_phone, concat(pat_st_address, ' ', pat_city, ' ', pat_state, ' ', pat_zipcode) as addr from wc_patient;");
        $stmt->execute();
        ...
        if(mysqli_num_rows($result) > 0)
        {
            ...
            { 
                ...
                echo "<tr><td>". $row['pat_id'] ."</td><td>". $row['pname'] ."</td><td>". "<a href=adminpatapp.php?id=".$row['pat_id'].">View Appointments</a>" ."</td><td>". "<a href=adminpatappcreate.php?id=".$row['pat_id'].">Create Appointments</a>" ."</td></tr>";
            }
            echo "</table>";  
