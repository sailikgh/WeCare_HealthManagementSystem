...
<div class="w3-padding-5">
      <form class="w3-container w3-card-4 w3-padding-16 w3-white" action="insertpat.php" method="POST">
	...
	<option value="WY">Wyoming</option>
      ...
      <div class="w3-section">      
        ...
        <select id="usern" name="usern" class="w3-input" required>
        <?php

          $stmt = $con->prepare("select * from wc_user where user_id>7000003;");
          $stmt->execute();
