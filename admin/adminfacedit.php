...
<div class="w3-padding-5">
      <form class="w3-container w3-card-4 w3-padding-16 w3-white" action="editfac.php" method="POST">
      <div class="w3-section">      
        <label><b>Doctor ID: <?= $docid?></b></label>
        <input class="w3-input" type="hidden" name="docid" id="docid" value=<?= $docid?> required>
      </div>
      <div class="w3-section">      
        <label><b>Doctor Name: <?= $hos_name?></b></label>
        <input class="w3-input" type="hidden" name="docname" id="docname" value=<?= $hos_name?> required>
      </div>
      <div class="w3-section">      
