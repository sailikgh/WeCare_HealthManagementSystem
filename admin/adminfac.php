...
<a href="adminfaccreate.php" class="w3-button w3-teal"
  style="position: fixed;bottom: 0;right: 0;">+ Add New Doctor</a>
...
<p> </p>
    ...
    <?php
        ...
        if(mysqli_num_rows($result) > 0)
        {
            ...
            { 
                echo "<tr><td>". $row['doc_id'] ."</td><td>". $row['docname'] ."</td><td>". $row['hos_name'] ."</td><td>". $row['addr'] ."</td><td>". $row['ofc_hrs'] ."</td><td>". $row['doc_phone_ofc'] ."</td><td>". $row['doc_phone_per'] ."</td><td>". "<a href=adminfacdet.php?id=".$row['doc_id'].">View</a>" ."</td><td>". "<a href=adminfacedit.php?id=".$row['doc_id'].">Edit</a>" ."</td>
                </tr>";
            }
            echo "</table>";  
